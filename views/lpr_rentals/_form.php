 ...
 * $partners, $coverageOptions, $canSelectBranch, $branches, $myBranchIds,
 * $myBranches, and $rental (array, edit only).
 */
  ...
  <div class="form-group">
    ...
    <?php if ($canSelectBranch): ?>
      <select class="form-control" id="branch_id" name="branch_id" required>
        ...
        <?php $selectedBranch = old('branch_id', (string) ($rental['branch_id'] ?? '')); ?>
